...
-- Own event frame: this used to register PLAYER_ENTERING_WORLD on the shared addon
-- object, silently replacing the core handler that loads every other module.
LingkanUI:EmbedEvents(LingkanUI.TabTargetArenaFix)

function LingkanUI.TabTargetArenaFix:Load()
    self:RegisterEvent("PLAYER_ENTERING_WORLD", function() TabTargetArenaFix() end)
